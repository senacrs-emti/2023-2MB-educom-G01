...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Nov-2023 às 13:14
...
(207, '1 K2Cr2O7 + 4 HCl → 2 CrCl3 + 4 KCl + 3 H2O + 1 Cl2', '2 K2Cr2O7 + 2 HCl → 3 CrCl3 + 2 KCl + 2 H2O + 1 Cl2', '2 K2Cr2O7 + 3 HCl → 4 CrCl3 + 3 KCl + 1 H2O + 2 Cl2'),
